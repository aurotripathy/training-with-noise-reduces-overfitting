...
In the likely everday scenario of a small dataset, an overfited model is a likely outcome, meaning that the model does not generalize very well to test data. In this example, we highlight a simple and powerful way to reduce overfitting.
