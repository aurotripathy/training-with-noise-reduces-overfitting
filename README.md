...
In the likely scenario of a small dataset, an overfited is a likely outcome, meaning that the model does not generalize very well to test data. In this example, we highlight a simple and powerful way to reduce overfitting.
